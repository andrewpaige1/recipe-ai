...
export default function Signup({ searchParams }: { searchParams: Message }) {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center p-4">
      <div className="relative sm:max-w-md w-full bg-white shadow-lg rounded-lg p-8">
        <Link
          href="/"
        ...
        <form className="flex flex-col w-full justify-center gap-4 text-foreground max-w-md mx-auto">
